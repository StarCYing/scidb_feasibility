...
local dictionaryLocation = "https://ntia.doc.gov/data/cps/stata"
local rawDataLocation = "https://ntia.doc.gov/data/cps/raw"
...
if "`location'" == "local" {
	...
	local dictionaryLocation = "O:\CPS Computer and Internet Use Supplement\Create and Verify Datasets"
	local rawDataLocation = "O:\CPS Computer and Internet Use Supplement\Raw"
	local saveLocation = "O:\CPS Computer and Internet Use Supplement\Stata"
}
...
foreach y in puernh1c pternh1c peernh2 pternh2 peernh10 pternh10 prernhly pternhly prernwa pternwa peern ptern puern2 ptern2 {
