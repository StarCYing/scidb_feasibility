...
global personVars "homeInternetUser internetUser adultInternetUser"
global householdVars "internetAnywhere internetAtHome noInternetAtHome mobileAtHome wiredHighSpeedAtHome satelliteAtHome dialUpAtHome homeEverOnline noNeedInterestMainReason tooExpensiveMainReason canUseElsewhereMainReason unavailableMainReason noComputerMainReason privSecMainReason computerAtHome"
